...
/// Web-specific implementation of Tesseract OCR service
Future<String?> recognizeImage(Uint8List imageBytes, String selectedLanguage) async {
  try {
    ...
    final promise = tesseract.callMethod('recognize', [dataUrl, selectedLanguage]);
...
/// Web-specific implementation of stroke to image conversion
